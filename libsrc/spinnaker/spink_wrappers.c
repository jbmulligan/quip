...
SPINK_WRAPPER_ONE_ARG(unregister_all_log_event_handlers,SystemUnregisterAllLogEventHandlers,spinSystem,hSystem)
...
SPINK_WRAPPER_TWO_ARG(register_sys_log_event_handler,SystemRegisterLogEventHandler,spinSystem,hSystem,spinLogEventHandler,hLogEventHandler)
//SPINK_WRAPPER_TWO_ARG(register_sys_log_event,SystemRegisterLogEvent,spinSystem,hSystem,spinLogEvent,hLogEvent)
SPINK_WRAPPER_TWO_ARG(unregister_sys_log_event_handler,SystemUnregisterLogEventHandler,spinSystem,hSystem,spinLogEventHandler,hLogEventHandler)
...
SPINK_WRAPPER_TWO_ARG(register_sys_arrival_event_handler,SystemRegisterDeviceArrivalEventHandler,spinSystem,hSystem,spinDeviceArrivalEventHandler,hDeviceArrivalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(register_sys_removal_event_handler,SystemRegisterDeviceRemovalEventHandler,spinSystem,hSystem,spinDeviceRemovalEventHandler,hDeviceRemovalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(unregister_sys_arrival_event_handler,SystemUnregisterDeviceArrivalEventHandler,spinSystem,hSystem,spinDeviceArrivalEventHandler,hDeviceArrivalEventHandler)
//SPINK_WRAPPER_TWO_ARG(unregister_sys_arrival_event,SystemUnregisterDeviceArrivalEvent,spinSystem,hSystem,spinDeviceArrivalEvent,hDeviceArrivalEvent)
SPINK_WRAPPER_TWO_ARG(unregister_sys_remove_event,SystemUnregisterDeviceRemovalEventHandler,spinSystem,hSystem,spinDeviceRemovalEventHandler,hDeviceRemovalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(register_sys_interface_event_handler,SystemRegisterInterfaceEventHandler,spinSystem,hSystem,spinInterfaceEventHandler,hInterfaceEventHandler)
...
SPINK_WRAPPER_TWO_ARG(unregister_sys_interface_event_handler,SystemUnregisterInterfaceEventHandler,spinSystem,hSystem,spinInterfaceEventHandler,hInterfaceEventHandler)
...
SPINK_WRAPPER_TWO_ARG(register_iface_arrival_event,InterfaceRegisterDeviceArrivalEventHandler,spinInterface,hInterface,spinDeviceArrivalEventHandler,hArrivalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(register_iface_remove_event_handler,InterfaceRegisterDeviceRemovalEventHandler,spinInterface,hInterface,spinDeviceRemovalEventHandler,hRemovalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(unregister_iface_arrival_event,InterfaceUnregisterDeviceArrivalEventHandler,spinInterface,hInterface,spinDeviceArrivalEventHandler,hArrivalEventHandler)
...
SPINK_WRAPPER_TWO_ARG(unregister_iface_remove_event,InterfaceUnregisterDeviceRemovalEventHandler,spinInterface,hInterface,spinDeviceRemovalEventHandler,hRemovalEventHandler)
SPINK_WRAPPER_TWO_ARG(register_iface_iface_event_handler,InterfaceRegisterInterfaceEventHandler,spinInterface,hInterface,spinInterfaceEventHandler,hInterfaceEventHandler)
...
SPINK_WRAPPER_TWO_ARG(unregister_iface_iface_event_handler,InterfaceUnregisterInterfaceEventHandler,spinInterface,hInterface,spinInterfaceEventHandler,hInterfaceEventHandler)
...
//SPINK_WRAPPER_TWO_ARG(unregister_cam_device_event,CameraUnregisterDeviceEvent,spinCamera,hCamera,spinDeviceEvent,hDeviceEvent)
SPINK_WRAPPER_TWO_ARG(register_cam_image_event,CameraRegisterImageEventHandler,spinCamera,hCamera,spinImageEventHandler,hImageEventHandler)
//SPINK_WRAPPER_TWO_ARG(register_cam_image_event,CameraRegisterImageEvent,spinCamera,hCamera,spinImageEvent,hImageEvent)
...
SPINK_WRAPPER_THREE_ARG(create_device_removal_event_handler,DeviceRemovalEventHandlerCreate,spinDeviceRemovalEventHandler*,phRemovalEvent,spinRemovalEventFunction,pFunction,void*,pUserData)
SPINK_WRAPPER_THREE_ARG(create_log_event_handler,LogEventHandlerCreate,spinLogEventHandler*,phLogEventHandler,spinLogEventFunction,pFunction,void*,pUserData)
